import { writeFileSync as writeFileSync$3302, unlinkSync as unlinkSync$3310, readFileSync as readFileSync$3297 } from "node:fs";
...
function _M0TPB12MutArrayViewGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(param0, param1, param2) {
  this.buf = param0;
  this.start = param1;
  this.end = param2;
}
...
_M0DTPC15error5Error40moonbitlang_2fx_2ffs_2eIOError_2eIOError.prototype.$tag = 2;
function _M0DTPC15error5Error61SDJM5_2fmoonbit_2ddataframe_2eDataFrameError_2eDataFrameError(param0) {
  this._0 = param0;
}
_M0DTPC15error5Error61SDJM5_2fmoonbit_2ddataframe_2eDataFrameError_2eDataFrameError.prototype.$tag = 1;
...
function _M0FPB8new__mapGsuE(capacity) {
  ...
  const _bind$3 = $make_array_len_and_init(capacity$2, undefined);
  const _bind$4 = undefined;
  return new _M0TPB3MapGsuE(_bind$3, 0, capacity$2, _bind, _bind$2, _bind$4, -1);
}
...
function _M0MPB3Map15set__with__hashGsuE(self, key, value, hash) {
  ...
  while (true) {
    ...
    if (_bind === undefined) {
      ...
      const _bind$2 = self.tail;
      const _bind$3 = undefined;
      const entry = new _M0TPB5EntryGsuE(_bind$2, _bind$3, psl, hash, key, value);
...
function _M0FPB7printlnGRP25SDJM519moonbit_2ddataframe9DataFrameE(input) {
  console.log(_M0IP016_24default__implPB4Show10to__stringGRP25SDJM519moonbit_2ddataframe9DataFrameE(input));
}
...
function _M0MPC15array12MutArrayView4swapGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr, i, j) {
...
function _M0MPC15array12MutArrayView5sliceGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr, start, end) {
  const _bind = arr.end - arr.start | 0;
  if (start < 0 || (start > end || end > _bind)) {
    $panic();
  }
  return new _M0TPB12MutArrayViewGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr.buf, start + arr.start | 0, end + arr.start | 0);
}
...
function _M0MPC15array12MutArrayView14rev__in__placeGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr) {
  const len = arr.end - arr.start | 0;
  if (2 === 0) {
    $panic();
  }
...
function _M0FPB23fixed__bubble__sort__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr, cmp) {
  const _bind = arr.end - arr.start | 0;
  let _tmp = 1;
  while (true) {
    const i = _tmp;
    if (i < _bind) {
      ...
      while (true) {
        ...
        if (j > 0 && cmp(arr.buf[arr.start + (j - 1 | 0) | 0], arr.buf[arr.start + j | 0]) > 0) {
          _M0MPC15array12MutArrayView4swapGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr, j, j - 1 | 0);
          _tmp$2 = j - 1 | 0;
          continue;
        } else {
          break;
...
function _M0FPB24fixed__choose__pivot__byN7sort__2S444GURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(_env, a, b) {
  const arr = _env._2;
  const cmp = _env._1;
  const swaps = _env._0;
  if (cmp(arr.buf[arr.start + a | 0], arr.buf[arr.start + b | 0]) > 0) {
    _M0MPC15array12MutArrayView4swapGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr, a, b);
    swaps.val = swaps.val + 1 | 0;
    return;
  } else {
    return;
...
function _M0FPB24fixed__choose__pivot__byN7sort__3S448GURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(_env, a, b, c) {
  _M0FPB24fixed__choose__pivot__byN7sort__2S444GURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(_env, a, b);
  _M0FPB24fixed__choose__pivot__byN7sort__2S444GURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(_env, b, c);
  _M0FPB24fixed__choose__pivot__byN7sort__2S444GURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(_env, a, b);
}
function _M0FPB24fixed__choose__pivot__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr, cmp) {
  const len = arr.end - arr.start | 0;
  const swaps = new _M0TPB8MutLocalGiE(0);
  if (4 === 0) {
    $panic();
  ...
  if (len >= 8) {
    ...
    if (len > 50) {
      _M0FPB24fixed__choose__pivot__byN7sort__3S448GURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(_env, a - 1 | 0, a, a + 1 | 0);
      _M0FPB24fixed__choose__pivot__byN7sort__3S448GURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(_env, b - 1 | 0, b, b + 1 | 0);
      _M0FPB24fixed__choose__pivot__byN7sort__3S448GURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(_env, c - 1 | 0, c, c + 1 | 0);
    }
    _M0FPB24fixed__choose__pivot__byN7sort__3S448GURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(_env, a, b, c);
  }
  if (swaps.val === 12) {
    _M0MPC15array12MutArrayView14rev__in__placeGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr);
    return { _0: (len - b | 0) - 1 | 0, _1: true };
  } else {
    return { _0: b, _1: swaps.val === 0 };
  }
}
function _M0FPB21fixed__sift__down__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr, index, cmp) {
  const len = arr.end - arr.start | 0;
  let _tmp = index;
  let _tmp$2 = (Math.imul(index, 2) | 0) + 1 | 0;
  while (true) {
    ...
    if (child < len) {
      ...
      _M0MPC15array12MutArrayView4swapGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr, index$2, child$2);
      _tmp = child$2;
      _tmp$2 = (Math.imul(child$2, 2) | 0) + 1 | 0;
      continue;
    } else {
...
function _M0FPB21fixed__heap__sort__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr, cmp) {
  const len = arr.end - arr.start | 0;
  if (2 === 0) {
    $panic();
  }
  ...
  while (true) {
    const i = _tmp;
    if (i >= 0) {
      _M0FPB21fixed__sift__down__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr, i, cmp);
      _tmp = i - 1 | 0;
      continue;
    } else {
      break;
  ...
  while (true) {
    const i = _tmp$2;
    if (i >= 1) {
      _M0MPC15array12MutArrayView4swapGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr, 0, i);
      _M0FPB21fixed__sift__down__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(_M0MPC15array12MutArrayView5sliceGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr, 0, i), 0, cmp);
      _tmp$2 = i - 1 | 0;
      continue;
    } else {
      return;
...
function _M0FPB20fixed__partition__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr, cmp, pivot_index) {
  _M0MPC15array12MutArrayView4swapGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr, pivot_index, (arr.end - arr.start | 0) - 1 | 0);
  const pivot = arr.buf[arr.start + ((arr.end - arr.start | 0) - 1 | 0) | 0];
  const _bind = (arr.end - arr.start | 0) - 1 | 0;
  let _tmp = 0;
  let _tmp$2 = 0;
  ...
  while (true) {
    ...
    if (j < _bind) {
      if (cmp(arr.buf[arr.start + j | 0], pivot) < 0) {
        if (i !== j) {
          _M0MPC15array12MutArrayView4swapGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr, i, j);
          _tmp = j + 1 | 0;
          _tmp$2 = i + 1 | 0;
          _tmp$3 = false;
          continue;
      ...
      _M0MPC15array12MutArrayView4swapGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr, i, (arr.end - arr.start | 0) - 1 | 0);
      return { _0: i, _1: partitioned };
    }
  }
}
function _M0FPB28fixed__try__bubble__sort__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr, cmp) {
  const _bind = arr.end - arr.start | 0;
  let _tmp = 1;
  let _tmp$2 = 0;
  while (true) {
...
function _M0FPB22fixed__quick__sort__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr, cmp, pred, limit) {
  let _tmp = limit;
  let _tmp$2 = arr;
  let _tmp$3 = pred;
  let _tmp$4 = true;
  ...
  while (true) {
    ...
    if (len <= 16) {
      if (len >= 2) {
        _M0FPB23fixed__bubble__sort__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr$2, cmp);
      }
      return undefined;
    }
    if (limit$2 === 0) {
      _M0FPB21fixed__heap__sort__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr$2, cmp);
      return undefined;
    }
    const _bind = _M0FPB24fixed__choose__pivot__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr$2, cmp);
    const _pivot_index = _bind._0;
    const _likely_sorted = _bind._1;
    if (was_partitioned && (balanced && _likely_sorted)) {
      if (_M0FPB28fixed__try__bubble__sort__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr$2, cmp)) {
        return undefined;
      }
    }
    const _bind$2 = _M0FPB20fixed__partition__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr$2, cmp, _pivot_index);
    const _pivot = _bind$2._0;
    const _partitioned = _bind$2._1;
    const _tmp$6 = _M0FPB7minimum(_pivot, len - _pivot | 0);
    if (8 === 0) {
    ...
    if (pred$2 === undefined) {
      ...
      if (cmp(_p, arr$2.buf[arr$2.start + _pivot | 0]) === 0) {
        ...
        _tmp = limit$3;
        _tmp$2 = _M0MPC15array12MutArrayView5sliceGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr$2, i, len);
        _tmp$4 = _partitioned;
        _tmp$5 = balanced$2;
        continue;
      }
    }
    const left = _M0MPC15array12MutArrayView5sliceGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr$2, 0, _pivot);
    const right = _M0MPC15array12MutArrayView5sliceGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(arr$2, _pivot + 1 | 0, len);
    if ((left.end - left.start | 0) < (right.end - right.start | 0)) {
      _M0FPB22fixed__quick__sort__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(left, cmp, pred$2, limit$3);
      _tmp = limit$3;
      _tmp$2 = right;
      ...
      _M0FPB22fixed__quick__sort__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(right, cmp, arr$2.buf[arr$2.start + _pivot | 0], limit$3);
      _tmp = limit$3;
      _tmp$2 = left;
      _tmp$4 = _partitioned;
      _tmp$5 = balanced$2;
...
function _M0MPC15array12MutArrayView8sort__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(self, cmp) {
  _M0FPB22fixed__quick__sort__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(self, cmp, undefined, _M0FPB17fixed__get__limit(self.end - self.start | 0));
}
function _M0MPC15array5Array4sortGdE(self) {
  const _bind = self.length;
  _M0MPC15array12MutArrayView4sortGdE(new _M0TPB12MutArrayViewGdE(self, 0, _bind));
}
function _M0MPC15array5Array8sort__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(self, cmp) {
  const _bind = self.length;
  _M0MPC15array12MutArrayView8sort__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(new _M0TPB12MutArrayViewGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(self, 0, _bind), cmp);
}
...
function _M0FP311moonbitlang1x7unicode15to__utf8__bytes(s) {
  ...
  while (true) {
    if (i.val < len) {
      const _tmp = i.val;
      const c = new _M0TPB8MutLocalGiE(_tmp >>> 0 < s.length ? s.charCodeAt(_tmp) : $oob());
      if (_M0MPC13int3Int22is__leading__surrogate(c.val)) {
        i.val = i.val + 1 | 0;
        const _tmp$2 = i.val;
        const l = _tmp$2 >>> 0 < s.length ? s.charCodeAt(_tmp$2) : $oob();
...
function _M0FP311moonbitlang1x7unicode16to__utf8__string(bytes) {
  ...
  while (true) {
    if (i.val < len) {
      const _tmp = i.val;
      const c = new _M0TPB8MutLocalGiE(_tmp >>> 0 < bytes.length ? bytes[_tmp] : $oob());
      if (c.val < 128) {
        ...
        if (c.val < 224) {
          ...
          c.val = _tmp$2 | (_tmp$3 >>> 0 < bytes.length ? bytes[_tmp$3] : $oob()) & 63;
          _M0MPC15array5Array4pushGcE(res, c.val);
          i.val = i.val + 2 | 0;
        } else {
          if (c.val < 240) {
            ...
            const _tmp$3 = i.val + 1 | 0;
            const _tmp$4 = _tmp$2 | ((_tmp$3 >>> 0 < bytes.length ? bytes[_tmp$3] : $oob()) & 63) << 6;
            const _tmp$5 = i.val + 2 | 0;
            c.val = _tmp$4 | (_tmp$5 >>> 0 < bytes.length ? bytes[_tmp$5] : $oob()) & 63;
            _M0MPC15array5Array4pushGcE(res, c.val);
            i.val = i.val + 3 | 0;
          } else {
            if ((i.val + 3 | 0) >= len) {
            ...
            const _tmp$3 = i.val + 1 | 0;
            const _tmp$4 = _tmp$2 | ((_tmp$3 >>> 0 < bytes.length ? bytes[_tmp$3] : $oob()) & 63) << 12;
            const _tmp$5 = i.val + 2 | 0;
            const _tmp$6 = _tmp$4 | ((_tmp$5 >>> 0 < bytes.length ? bytes[_tmp$5] : $oob()) & 63) << 6;
            const _tmp$7 = i.val + 3 | 0;
            c.val = _tmp$6 | (_tmp$7 >>> 0 < bytes.length ? bytes[_tmp$7] : $oob()) & 63;
            let hi;
            let lo;
            _L: {
              const _bind = _M0FP311moonbitlang1x7unicode21char__to__utf16__pair(c.val);
              if (_bind === undefined) {
                break;
              } else {
                const _Some = _bind;
...
function _M0FP311moonbitlang1x2fs16read__file__sync(_tmp) {
  return readFileSync$3297(_tmp);
}
function _M0FP311moonbitlang1x2fs17write__file__sync(_tmp, _tmp$2) {
  return writeFileSync$3302(_tmp, _tmp$2);
}
...
function _M0FP311moonbitlang1x2fs18remove__file__sync(_tmp) {
  return unlinkSync$3310(_tmp);
}
...
function _M0IP25SDJM519moonbit_2ddataframe5ValuePB2Eq5equal(_x_727, _x_728) {
  let _x0_735;
  let _y0_736;
  _L: {
    let _x0_733;
      ...
      _L$3: {
        ...
        _L$4: {
          switch (_x_727.$tag) {
            ...
            case 1: {
              const _Int = _x_727;
              const _$42$x0_729 = _Int._0;
              if (_x_728.$tag === 1) {
                const _Int$2 = _x_728;
                const _$42$y0_730 = _Int$2._0;
                _x0_729 = _$42$x0_729;
                _y0_730 = _$42$y0_730;
                break _L$4;
              } else {
            ...
            case 2: {
              const _Double = _x_727;
              const _$42$x0_731 = _Double._0;
              if (_x_728.$tag === 2) {
                const _Double$2 = _x_728;
                const _$42$y0_732 = _Double$2._0;
                _x0_731 = _$42$x0_731;
                _y0_732 = _$42$y0_732;
                break _L$3;
              } else {
            ...
            case 3: {
              const _Bool = _x_727;
              const _$42$x0_733 = _Bool._0;
              if (_x_728.$tag === 3) {
                const _Bool$2 = _x_728;
                const _$42$y0_734 = _Bool$2._0;
                _x0_733 = _$42$x0_733;
                _y0_734 = _$42$y0_734;
                break _L$2;
              } else {
            ...
            default: {
              const _Str = _x_727;
              const _$42$x0_735 = _Str._0;
              if (_x_728.$tag === 4) {
                const _Str$2 = _x_728;
                const _$42$y0_736 = _Str$2._0;
                _x0_735 = _$42$x0_735;
                _y0_736 = _$42$y0_736;
                break _L;
              } else {
        ...
        return _x0_729 === _y0_730;
      }
      return _x0_731 === _y0_732;
    }
    return _x0_733 === _y0_734;
  }
  return _x0_735 === _y0_736;
}
function _M0IP25SDJM519moonbit_2ddataframe8DataTypePB2Eq5equal(_x_639, _x_640) {
  switch (_x_639) {
    case 0: {
      if (_x_640 === 0) {
        return true;
...
function _M0IP25SDJM519moonbit_2ddataframe5ValuePB7Compare7compare(self, other) {
  _L: {
    ...
    let b;
    _L$2: {
      const _bind = _M0MP25SDJM519moonbit_2ddataframe5Value10as__double(self);
      const _bind$2 = _M0MP25SDJM519moonbit_2ddataframe5Value10as__double(other);
      if (_bind.$tag === 1) {
        const _Some = _bind;
        const _a = _Some._0;
        if (_bind$2.$tag === 1) {
...
function _M0FP25SDJM519moonbit_2ddataframe18looks__like__float(s) {
  const _bind = ".";
  if (_M0MPC16string6String8contains(s, new _M0TPC16string10StringView(_bind, 0, _bind.length))) {
    return true;
  } else {
    let _tmp;
    const _bind$2 = "e";
    if (_M0MPC16string6String8contains(s, new _M0TPC16string10StringView(_bind$2, 0, _bind$2.length))) {
      ...
      const _bind$3 = "E";
      _tmp = _M0MPC16string6String8contains(s, new _M0TPC16string10StringView(_bind$3, 0, _bind$3.length));
    }
    return _tmp;
  }
}
function _M0MP25SDJM519moonbit_2ddataframe5Value5parse(raw, infer_types, null_values) {
  ...
  if (_M0FP25SDJM519moonbit_2ddataframe14is__plain__int(raw)) {
    ...
    _L: {
      _L$2: {
        const _bind = _M0FPC28internal7strconv20parse__int64_2einner(new _M0TPC16string10StringView(raw, 0, raw.length), 0);
        if (_bind.$tag === 1) {
          const _ok = _bind;
          parsed = _ok._0;
        } else {
  ...
  if (_M0FP25SDJM519moonbit_2ddataframe18looks__like__float(raw)) {
    ...
    _L: {
      _L$2: {
        const _bind = _M0FPC28internal7strconv13parse__double(new _M0TPC16string10StringView(raw, 0, raw.length));
        let _tmp;
        if (_bind.$tag === 1) {
          const _ok = _bind;
          _tmp = _ok._0;
        ...
        parsed_double = new _M0DTPC16option6OptionGdE4Some(_tmp);
        break _L;
      }
...
function _M0MP25SDJM519moonbit_2ddataframe6Series4mean(self) {
  ...
  while (true) {
    ...
    if (_ < _bind$2) {
      ...
      _L: {
        _L$2: {
          const _bind$3 = _M0MP25SDJM519moonbit_2ddataframe5Value10as__double(v);
          if (_bind$3.$tag === 1) {
            const _Some = _bind$3;
            const _d = _Some._0;
            d = _d;
...
function _M0MP25SDJM519moonbit_2ddataframe6Series6median(self) {
  ...
  if ((n % 2 | 0) === 1) {
    ...
    const _tmp = _M0MPC15array5Array2atGdE(nums, (n / 2 | 0) - 1 | 0);
    if (2 === 0) {
      $panic();
    }
    return new _M0DTP25SDJM519moonbit_2ddataframe5Value6Double((_tmp + _M0MPC15array5Array2atGdE(nums, n / 2 | 0)) / 2);
  }
}
...
function _M0MP25SDJM519moonbit_2ddataframe6Series3std(self) {
  let v;
  _L: {
    const _bind = _M0MP25SDJM519moonbit_2ddataframe6Series8variance(self);
    if (_bind.$tag === 2) {
      const _Double = _bind;
      const _v = _Double._0;
      v = _v;
...
function _M0MP25SDJM519moonbit_2ddataframe6Series13value__counts(self) {
  const entries = [];
  const _bind = [];
  const positions = _M0MPB3Map3MapGsiE(new _M0TPB9ArrayViewGUsiEE(_bind, 0, 0), undefined);
  const _bind$2 = self.values;
  const _bind$3 = _bind$2.length;
  let _tmp = 0;
  while (true) {
    ...
    if (_ < _bind$3) {
      ...
      _L: {
        ...
        _L$2: {
          _L$3: {
            const _bind$4 = _M0MPB3Map3getGsiE(positions, key);
  ...
  _M0MPC15array5Array8sort__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(entries, (a, b) => a._1 !== b._1 ? b._1 - a._1 | 0 : a._2 - b._2 | 0);
...
function _M0FP25SDJM519moonbit_2ddataframe8row__key(frame, i, keys) {
  ...
  while (true) {
    ...
    if (_ < _bind) {
      ...
      _L: {
        _L$2: {
          const _bind$2 = _M0MP25SDJM519moonbit_2ddataframe9DataFrame6column(frame, k);
          if (_bind$2 === undefined) {
...
function _M0MP25SDJM519moonbit_2ddataframe9DataFrame5nrows(self) {
  let c;
  _L: {
    const _bind = _M0MPC15array5Array3getGsE(self.columns, 0);
    if (_bind === undefined) {
      return 0;
    } else {
      const _Some = _bind;
...
function _M0FP25SDJM519moonbit_2ddataframe11index__rows(frame, keys) {
  const _bind = [];
  const index = _M0MPB3Map3MapGsRPB5ArrayGiEE(new _M0TPB9ArrayViewGUsRPB5ArrayGiEEE(_bind, 0, 0), undefined);
  let _tmp = 0;
  while (true) {
    const i = _tmp;
    if (i < _M0MP25SDJM519moonbit_2ddataframe9DataFrame5nrows(frame)) {
      ...
      _L: {
        _L$2: {
          const _bind$2 = _M0MPB3Map3getGsRPB5ArrayGiEE(index, key);
          if (_bind$2.$tag === 1) {
            const _Some = _bind$2;
  ...
  if (how === 2) {
    ...
    while (true) {
      ...
      if (j < _M0MP25SDJM519moonbit_2ddataframe9DataFrame5nrows(right)) {
        ...
        _L: {
          _L$2: {
            const _bind = _M0MPB3Map3getGsRPB5ArrayGiEE(index, _M0FP25SDJM519moonbit_2ddataframe8row__key(right, j, on));
            if (_bind.$tag === 1) {
              const _Some = _bind;
              const _rows = _Some._0;
              rows = _rows;
    ...
    while (true) {
      ...
      if (i < _M0MP25SDJM519moonbit_2ddataframe9DataFrame5nrows(left)) {
        ...
        _L: {
          _L$2: {
            const _bind = _M0MPB3Map3getGsRPB5ArrayGiEE(index, _M0FP25SDJM519moonbit_2ddataframe8row__key(left, i, on));
            if (_bind.$tag === 1) {
              const _Some = _bind;
              const _rows = _Some._0;
              rows = _rows;
  ...
  while (true) {
    ...
    if (_ < _bind) {
      ...
      if (r < 0) {
        ...
        _L: {
          _L$2: {
            const _bind$2 = _M0MP25SDJM519moonbit_2ddataframe9DataFrame6column(frame, name);
            if (_bind$2 === undefined) {
              _tmp$2 = _M0DTP25SDJM519moonbit_2ddataframe5Value4Null__;
            } else {
              const _Some = _bind$2;
              const _col = _Some;
              col = _col;
          ...
          _tmp$2 = _M0MP25SDJM519moonbit_2ddataframe6Series3get(col, r);
        }
...
function _M0FP25SDJM519moonbit_2ddataframe11gather__key(left, right, name, left_rows, right_rows) {
  ...
  while (true) {
    ...
    if (i < left_rows.length) {
      ...
      _L: {
        _L$2: {
          const _bind = _M0MP25SDJM519moonbit_2ddataframe9DataFrame6column(frame, name);
          if (_bind === undefined) {
            _tmp$2 = _M0DTP25SDJM519moonbit_2ddataframe5Value4Null__;
          } else {
            const _Some = _bind;
        ...
        _tmp$2 = _M0MP25SDJM519moonbit_2ddataframe6Series3get(col, row);
      }
      _M0MPC15array5Array4pushGsE(values, _tmp$2);
      _tmp = i + 1 | 0;
      continue;
...
function _M0MP25SDJM519moonbit_2ddataframe9DataFrame11has__column(self, name) {
  const _bind = _M0MP25SDJM519moonbit_2ddataframe9DataFrame6column(self, name);
  return !(_bind === undefined);
}
function _M0MP25SDJM519moonbit_2ddataframe9DataFrame3new(columns) {
  let first;
  _L: {
    const _bind = _M0MPC15array5Array3getGsE(columns, 0);
    if (_bind === undefined) {
  ...
  while (true) {
    ...
    if (_ < _bind$2) {
      ...
      if (_M0MP25SDJM519moonbit_2ddataframe6Series3len(s) !== n) {
        ...
        const _bind$3 = _M0FP25SDJM519moonbit_2ddataframe5errorGuE(_M0MPB13StringBuilder10to__string(_string_builder));
        if (_bind$3.$tag === 1) {
          const _ok = _bind$3;
          _ok._0;
        } else {
...
function _M0MP25SDJM519moonbit_2ddataframe9DataFrame12join_2einner(self, other, on, how) {
  ...
  while (true) {
    ...
    if (_ < _bind) {
      ...
      if (!_M0MP25SDJM519moonbit_2ddataframe9DataFrame11has__column(self, k)) {
        ...
        const _bind$2 = _M0FP25SDJM519moonbit_2ddataframe5errorGuE(_M0MPB13StringBuilder10to__string(_string_builder));
        if (_bind$2.$tag === 1) {
          const _ok = _bind$2;
          _ok._0;
        } else {
  ...
  const right_plan = [];
  const _bind$2 = _M0MP25SDJM519moonbit_2ddataframe9DataFrame7columns(other);
  const _bind$3 = _bind$2.length;
  let _tmp$2 = 0;
  while (true) {
    const _ = _tmp$2;
    if (_ < _bind$3) {
      ...
      _L: {
        ...
        const _bind$4 = right_plan.length;
        let _tmp$3 = 0;
        while (true) {
          const _$2 = _tmp$3;
          if (_$2 < _bind$4) {
  ...
  let right_rows;
  _L: {
    const _bind$4 = _M0FP25SDJM519moonbit_2ddataframe11join__pairs(self, other, on, how);
    const _left_rows = _bind$4._0;
    const _right_rows = _bind$4._1;
  ...
  const _bind$5 = _M0MP25SDJM519moonbit_2ddataframe9DataFrame7columns(self);
...
function _M0MP25SDJM519moonbit_2ddataframe9DataFrame12with__column(self, series) {
  ...
  if (_M0MP25SDJM519moonbit_2ddataframe6Series3len(series) !== n) {
    ...
    _M0IPB13StringBuilderPB6Logger13write__string(_string_builder, " cells, expected ");
    _M0MPB13StringBuilder13write__objectGiE(_string_builder, n);
    const _bind = _M0FP25SDJM519moonbit_2ddataframe5errorGuE(_M0MPB13StringBuilder10to__string(_string_builder));
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _ok._0;
    } else {
...
function _M0MP25SDJM519moonbit_2ddataframe9DataFrame11map__column(self, name, f) {
  ...
  if (_bind === undefined) {
    ...
    const _bind$2 = _M0FP25SDJM519moonbit_2ddataframe5errorGRP25SDJM519moonbit_2ddataframe6SeriesE(_M0MPB13StringBuilder10to__string(_string_builder));
    if (_bind$2.$tag === 1) {
      const _ok = _bind$2;
      col = _ok._0;
    } else {
...
function _M0FP25SDJM519moonbit_2ddataframe16read__text__file(path) {
  ...
  _L: {
    ...
    return new _M0DTPC16result6ResultGsRP25SDJM519moonbit_2ddataframe14DataFrameErrorE2Ok(_tmp);
  }
  let msg;
  _L$2: {
  ...
  while (true) {
    ...
    if (j < ncols) {
      ...
      const values = _M0MPC15array5Array3mapGRPB5ArrayGsERP25SDJM519moonbit_2ddataframe5ValueE(data, (row) => {
        let cell;
        _L$2: {
          const _bind = _M0MPC15array5Array3getGsE(row, j);
          if (_bind === undefined) {
            return _M0DTP25SDJM519moonbit_2ddataframe5Value4Null__;
          } else {
            const _Some = _bind;
...
function _M0MP25SDJM519moonbit_2ddataframe9DataFrame9read__csv(path, options) {
  const _bind = _M0FP25SDJM519moonbit_2ddataframe16read__text__file(path);
  let _tmp;
  if (_bind.$tag === 1) {
    const _ok = _bind;
    _tmp = _ok._0;
  ...
  return _M0MP25SDJM519moonbit_2ddataframe9DataFrame9from__csv(_tmp, options);
}
...
function _M0FP25SDJM519moonbit_2ddataframe11escape__csv(s, delimiter) {
  ...
  if (_M0MPC16string6String8contains(s, new _M0TPC16string10StringView(_bind, 0, _bind.length))) {
    ...
    if (_M0MPC16string6String14contains__char(s, delimiter)) {
      ...
      if (_M0MPC16string6String8contains(s, new _M0TPC16string10StringView(_bind$2, 0, _bind$2.length))) {
        ...
        const _bind$3 = "\r";
        _tmp$2 = _M0MPC16string6String8contains(s, new _M0TPC16string10StringView(_bind$3, 0, _bind$3.length));
      }
      _tmp = _tmp$2;
    }
    needs_quotes = _tmp;
  ...
  if (needs_quotes) {
    ...
    const _bind$3 = "\"\"";
    return `\"${_M0MPC16string6String12replace__all(s, _tmp, new _M0TPC16string10StringView(_bind$3, 0, _bind$3.length))}\"`;
  } else {
    return s;
  }
}
function _M0MP25SDJM519moonbit_2ddataframe9DataFrame3get(self, row, column) {
  let s;
  _L: {
    const _bind = _M0MP25SDJM519moonbit_2ddataframe9DataFrame6column(self, column);
    if (_bind === undefined) {
      return undefined;
    } else {
      const _Some = _bind;
    ...
    if (i < n) {
      ...
      while (true) {
        ...
        if (j < names.length) {
          ...
          let v;
          const _bind = _M0MP25SDJM519moonbit_2ddataframe9DataFrame3get(self, i, _M0MPC15array5Array2atGsE(names, j));
          if (_bind === undefined) {
...
function _M0MP25SDJM519moonbit_2ddataframe9DataFrame18write__csv_2einner(self, path, delimiter) {
  ...
  let _try_err;
  _L: {
    const _bind = _M0FP311moonbitlang1x2fs31write__string__to__file_2einner(path, text, "utf8");
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _ok._0;
    } else {
...
function _M0MP25SDJM519moonbit_2ddataframe9DataFrame8to__json(self) {
  ...
  while (true) {
    ...
    if (i < n) {
      const _bind = [];
      const m = _M0MPB3Map3MapGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind, 0, 0), undefined);
      let _tmp$2 = 0;
      while (true) {
        const j = _tmp$2;
        if (j < names.length) {
          let v;
          const _bind$2 = _M0MP25SDJM519moonbit_2ddataframe9DataFrame3get(self, i, _M0MPC15array5Array2atGsE(names, j));
          if (_bind$2 === undefined) {
            v = _M0DTP25SDJM519moonbit_2ddataframe5Value4Null__;
          } else {
            const _Some = _bind$2;
...
function _M0MP25SDJM519moonbit_2ddataframe9DataFrame16filter__contains(self, column, substring) {
  return _M0MP25SDJM519moonbit_2ddataframe9DataFrame10filter__by(self, column, (v) => {
    let s;
    _L: {
      const _bind = _M0MP25SDJM519moonbit_2ddataframe5Value10as__string(v);
      if (_bind === undefined) {
        return false;
      } else {
        const _Some = _bind;
...
function _M0MP25SDJM519moonbit_2ddataframe9DataFrame8describe(self) {
  ...
  const maxs = [];
  const stds = [];
  const _bind = _M0MP25SDJM519moonbit_2ddataframe9DataFrame6series(self);
  const _bind$2 = _bind.length;
  let _tmp = 0;
  while (true) {
    const _ = _tmp;
...
function _M0MP25SDJM519moonbit_2ddataframe3Row3get(self, column) {
  let s;
  _L: {
    const _bind = _M0MP25SDJM519moonbit_2ddataframe9DataFrame6column(self.df, column);
    if (_bind === undefined) {
      return undefined;
    } else {
      const _Some = _bind;
...
function _M0MP25SDJM519moonbit_2ddataframe3Row11get__double(self, column) {
  let v;
  _L: {
    const _bind = _M0MP25SDJM519moonbit_2ddataframe3Row3get(self, column);
    if (_bind === undefined) {
      return _M0DTPC16option6OptionGdE4None__;
    } else {
      const _Some = _bind;
  ...
  return _M0MP25SDJM519moonbit_2ddataframe5Value10as__double(v);
}
function _M0MP25SDJM519moonbit_2ddataframe3Row11get__string(self, column) {
  let v;
  _L: {
    const _bind = _M0MP25SDJM519moonbit_2ddataframe3Row3get(self, column);
    if (_bind === undefined) {
  ...
  return _M0MP25SDJM519moonbit_2ddataframe5Value10as__string(v);
}
...
function _M0MP25SDJM519moonbit_2ddataframe9DataFrame6select(self, names) {
  const _bind = _M0MPC15array5Array3mapGsRP25SDJM519moonbit_2ddataframe6SeriesEHRP25SDJM519moonbit_2ddataframe14DataFrameError(names, (n) => {
    let s;
    _L: {
      const _bind$2 = _M0MP25SDJM519moonbit_2ddataframe9DataFrame6column(self, n);
      if (_bind$2 === undefined) {
        const _string_builder = _M0MPB13StringBuilder21StringBuilder_2einner(16);
        _M0IPB13StringBuilderPB6Logger13write__string(_string_builder, "no such column: ");
  ...
  return _M0MP25SDJM519moonbit_2ddataframe9DataFrame3new(_tmp);
}
...
function _M0MP25SDJM519moonbit_2ddataframe9DataFrame14derive__column(self, name, f) {
  const values = [];
  let _tmp = 0;
  while (true) {
    const i = _tmp;
    if (i < _M0MP25SDJM519moonbit_2ddataframe9DataFrame5nrows(self)) {
      _M0MPC15array5Array4pushGsE(values, f(new _M0TP25SDJM519moonbit_2ddataframe3Row(self, i)));
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  return _M0MP25SDJM519moonbit_2ddataframe9DataFrame12with__column(self, _M0MP25SDJM519moonbit_2ddataframe6Series3new(name, values));
}
function _M0MP25SDJM519moonbit_2ddataframe16GroupedDataFrame3new(source, keys) {
  ...
  while (true) {
    ...
    if (i < n) {
      const key = _M0MPC15array5Array3mapGsRP25SDJM519moonbit_2ddataframe5ValueE(keys, (k) => {
        let c;
        _L: {
          const _bind = _M0MP25SDJM519moonbit_2ddataframe9DataFrame6column(source, k);
          if (_bind === undefined) {
            return _M0DTP25SDJM519moonbit_2ddataframe5Value4Null__;
          } else {
            const _Some = _bind;
  ...
  _M0MPC15array5Array8sort__byGURPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEiEE(pairs, (a, b) => _M0FPB7compareGRPB5ArrayGRP25SDJM519moonbit_2ddataframe5ValueEE(a._0, b._0));
  const groups = [];
...
function _M0FP25SDJM519moonbit_2ddataframe11sub__series(source, name, indices) {
  let col;
  _L: {
    const _bind = _M0MP25SDJM519moonbit_2ddataframe9DataFrame6column(source, name);
    if (_bind === undefined) {
...
function _M0MP25SDJM519moonbit_2ddataframe16GroupedDataFrame9aggregate(self, specs) {
  ...
  while (true) {
    ...
    if (_ < _bind) {
      ...
      _L$2: {
        _L$3: {
          const _bind$2 = _M0MP25SDJM519moonbit_2ddataframe11Aggregation6column(agg);
          if (_bind$2 === undefined) {
          } else {
            const _Some = _bind$2;
            const _name = _Some;
...
(() => {
  let _try_err;
  _L: {
    const _bind = _M0MP25SDJM519moonbit_2ddataframe9DataFrame9from__csv("region,rep,units,price\nNorth,Alice,10,2.5\nSouth,Bob,5,3.0\nNorth,Bob,7,2.5\nEast,Carol,12,1.5\nSouth,Alice,3,3.0\nEast,,4,1.5", undefined);
    let sales;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      sales = _ok._0;
    ...
    _M0FPB7printlnGsE("== loaded ==");
    _M0FPB7printlnGRP25SDJM519moonbit_2ddataframe9DataFrameE(sales);
    _M0FPB7printlnGsE("\n== filter: units >= 7 (null cells never match) ==");
    const _bind$2 = _M0MP25SDJM519moonbit_2ddataframe9DataFrame10filter__ge(sales, "units", _M0MP25SDJM519moonbit_2ddataframe5Value3int(7));
    let _tmp;
    if (_bind$2.$tag === 1) {
      const _ok = _bind$2;
      _tmp = _ok._0;
    ...
    _M0FPB7printlnGRP25SDJM519moonbit_2ddataframe9DataFrameE(_tmp);
    _M0FPB7printlnGsE("\n== filter: rows with a rep, whose name contains \"o\" ==");
    const _bind$3 = _M0MP25SDJM519moonbit_2ddataframe9DataFrame17filter__not__null(sales, "rep");
    let _tmp$2;
    if (_bind$3.$tag === 1) {
      const _ok = _bind$3;
      _tmp$2 = _ok._0;
    ...
    const _bind$4 = _M0MP25SDJM519moonbit_2ddataframe9DataFrame16filter__contains(_tmp$2, "rep", "o");
    let _tmp$3;
    if (_bind$4.$tag === 1) {
      const _ok = _bind$4;
      _tmp$3 = _ok._0;
    ...
    _M0FPB7printlnGRP25SDJM519moonbit_2ddataframe9DataFrameE(_tmp$3);
    _M0FPB7printlnGsE("\n== filter: a predicate over the whole Row ==");
    _M0FPB7printlnGRP25SDJM519moonbit_2ddataframe9DataFrameE(_M0MP25SDJM519moonbit_2ddataframe9DataFrame6filter(sales, (r) => _M0IPC16option6OptionPB2Eq5equalGsE(_M0MP25SDJM519moonbit_2ddataframe3Row11get__string(r, "rep"), "Bob")));
    _M0FPB7printlnGsE("\n== transform: map_column, matching on a Value ==");
    const _bind$5 = _M0MP25SDJM519moonbit_2ddataframe9DataFrame11map__column(sales, "units", (v) => {
      let i;
      _L$2: {
        if (v.$tag === 1) {
          const _Int = v;
    ...
    _M0FPB7printlnGRP25SDJM519moonbit_2ddataframe9DataFrameE(_M0MP25SDJM519moonbit_2ddataframe9DataFrame12head_2einner(_tmp$4, 3));
    _M0FPB7printlnGsE("\n== transform: derive revenue = units * price ==");
    const _bind$6 = _M0MP25SDJM519moonbit_2ddataframe9DataFrame14derive__column(sales, "revenue", (r) => {
      _L$2: {
        let units;
        let price;
        _L$3: {
          const _bind$7 = _M0MP25SDJM519moonbit_2ddataframe3Row11get__double(r, "units");
          const _bind$8 = _M0MP25SDJM519moonbit_2ddataframe3Row11get__double(r, "price");
          if (_bind$7.$tag === 1) {
            const _Some = _bind$7;
            const _units = _Some._0;
            if (_bind$8.$tag === 1) {
              const _Some$2 = _bind$8;
              const _price = _Some$2._0;
              units = _units;
              price = _price;
              break _L$3;
            } else {
        ...
        return _M0MP25SDJM519moonbit_2ddataframe5Value6double(units * price);
      }
      return _M0MP25SDJM519moonbit_2ddataframe5Value4null();
    });
    let priced;
    if (_bind$6.$tag === 1) {
      const _ok = _bind$6;
    ...
    const _bind$7 = _M0MP25SDJM519moonbit_2ddataframe9DataFrame6select(priced, ["region", "rep", "units", "price", "revenue"]);
    let _tmp$5;
    if (_bind$7.$tag === 1) {
      const _ok = _bind$7;
      _tmp$5 = _ok._0;
    ...
    _M0FPB7printlnGRP25SDJM519moonbit_2ddataframe9DataFrameE(_tmp$5);
    _M0FPB7printlnGsE("\n== aggregate: totals per region ==");
    const _bind$8 = _M0MP25SDJM519moonbit_2ddataframe9DataFrame9group__by(priced, ["region"]);
    let _tmp$6;
    if (_bind$8.$tag === 1) {
      const _ok = _bind$8;
      _tmp$6 = _ok._0;
    ...
    const _bind$9 = _M0MP25SDJM519moonbit_2ddataframe16GroupedDataFrame9aggregate(_tmp$6, [{ _0: "rows", _1: _M0DTP25SDJM519moonbit_2ddataframe11Aggregation5Count__ }, { _0: "total_units", _1: new _M0DTP25SDJM519moonbit_2ddataframe11Aggregation3Sum("units") }, { _0: "total_revenue", _1: new _M0DTP25SDJM519moonbit_2ddataframe11Aggregation3Sum("revenue") }, { _0: "mean_price", _1: new _M0DTP25SDJM519moonbit_2ddataframe11Aggregation4Mean("price") }, { _0: "reps", _1: new _M0DTP25SDJM519moonbit_2ddataframe11Aggregation7NUnique("rep") }]);
    let by_region;
    if (_bind$9.$tag === 1) {
      const _ok = _bind$9;
      by_region = _ok._0;
    ...
    _M0FPB7printlnGRP25SDJM519moonbit_2ddataframe9DataFrameE(by_region);
    _M0FPB7printlnGsE("\n== describe: numeric summary ==");
    _M0FPB7printlnGRP25SDJM519moonbit_2ddataframe9DataFrameE(_M0MP25SDJM519moonbit_2ddataframe9DataFrame8describe(priced));
    _M0FPB7printlnGsE("\n== join: attach the manager for each region ==");
    const _bind$10 = _M0MP25SDJM519moonbit_2ddataframe9DataFrame9from__csv("region,manager\nNorth,Dana\nSouth,Erin\nWest,Frank\n", undefined);
    let managers;
    if (_bind$10.$tag === 1) {
      const _ok = _bind$10;
      managers = _ok._0;
    ...
    _M0FPB7printlnGRP25SDJM519moonbit_2ddataframe9DataFrameE(managers);
    _M0FPB7printlnGsE("left join keeps every left row:");
    const _bind$11 = _M0MP25SDJM519moonbit_2ddataframe9DataFrame12join_2einner(priced, managers, ["region"], 1);
    let _tmp$7;
    if (_bind$11.$tag === 1) {
      const _ok = _bind$11;
      _tmp$7 = _ok._0;
    ...
    _M0FPB7printlnGRP25SDJM519moonbit_2ddataframe9DataFrameE(_M0MP25SDJM519moonbit_2ddataframe9DataFrame12head_2einner(_tmp$7, 3));
    _M0FPB7printlnGsE("\n== value_counts: how many rows per region ==");
    const _bind$12 = _M0MP25SDJM519moonbit_2ddataframe9DataFrame21value__counts_2einner(priced, "region", false);
    let _tmp$8;
    if (_bind$12.$tag === 1) {
      const _ok = _bind$12;
      _tmp$8 = _ok._0;
    ...
    _M0FPB7printlnGRP25SDJM519moonbit_2ddataframe9DataFrameE(_tmp$8);
    _M0FPB7printlnGsE("\n== persist: CSV round trip via disk ==");
    const path = "demo_sales.csv";
    const _bind$13 = _M0MP25SDJM519moonbit_2ddataframe9DataFrame18write__csv_2einner(priced, path, 44);
    if (_bind$13.$tag === 1) {
      const _ok = _bind$13;
      _ok._0;
    } else {
    ...
    const _bind$14 = _M0MP25SDJM519moonbit_2ddataframe9DataFrame9read__csv(path, undefined);
    let reloaded;
    if (_bind$14.$tag === 1) {
      const _ok = _bind$14;
      reloaded = _ok._0;
    ...
    const _string_builder = _M0MPB13StringBuilder21StringBuilder_2einner(15);
    _M0IPB13StringBuilderPB6Logger13write__string(_string_builder, "wrote ");
    _M0MPB13StringBuilder13write__objectGiE(_string_builder, _M0MP25SDJM519moonbit_2ddataframe9DataFrame5nrows(reloaded));
    _M0IPB13StringBuilderPB6Logger13write__string(_string_builder, " rows to ");
    _M0MPB13StringBuilder13write__objectGsE(_string_builder, path);
    _M0FPB7printlnGsE(_M0MPB13StringBuilder10to__string(_string_builder));
    let _try_err$2;
    _L$2: {
      _L$3: {
        const _bind$15 = _M0FP311moonbitlang1x2fs12remove__file(path);
        if (_bind$15.$tag === 1) {
          const _ok = _bind$15;
          _ok._0;
        } else {
    ...
    const _bind$15 = _M0MP25SDJM519moonbit_2ddataframe9DataFrame9from__csv("north;10\nsouth;20\n", _M0MP25SDJM519moonbit_2ddataframe11ReadOptions3new(false, 59, false, _M0DTPC16option6OptionGRPB5ArrayGsEE4None__));
    let tsv;
    if (_bind$15.$tag === 1) {
      const _ok = _bind$15;
      tsv = _ok._0;
    ...
    _M0FPB7printlnGRP25SDJM519moonbit_2ddataframe9DataFrameE(tsv);
    _M0FPB7printlnGsE("\n== to_json ==");
    const _bind$16 = new _M0DTPC16result6ResultGuRPC15error5ErrorE2Ok(_M0FPB7printlnGsE(_M0MP25SDJM519moonbit_2ddataframe9DataFrame8to__json(by_region)));
    if (_bind$16.$tag === 1) {
      const _ok = _bind$16;
      _ok._0;
      return;
  ...
  const err = _try_err;
  _M0FPC15abort5abortGuE(_M0FP15Error10to__string(err));
})();
