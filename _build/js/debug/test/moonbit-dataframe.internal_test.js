...
_M0DTPC15error5Error97SDJM5_2fmoonbit_2ddataframe_2eMoonBitTestDriverInternalJsError_2eMoonBitTestDriverInternalJsError.prototype.$tag = 4;
...
_M0DTPC15error5Error99SDJM5_2fmoonbit_2ddataframe_2eMoonBitTestDriverInternalSkipTest_2eMoonBitTestDriverInternalSkipTest.prototype.$tag = 1;
...
function _M0IP016_24default__implP25SDJM519moonbit_2ddataframe21MoonBit__Test__Driver9run__testGRP25SDJM519moonbit_2ddataframe41MoonBit__Test__Driver__Internal__No__ArgsE(_discard_, _discard_$2, _discard_$3, _discard_$4, _discard_$5, _discard_$6) {
...
function _M0FP25SDJM519moonbit_2ddataframe44moonbit__test__driver__internal__do__execute(async_tests, filename, index) {
  ...
  _L: {
    let _tmp;
    const _bind = _M0IP016_24default__implP25SDJM519moonbit_2ddataframe21MoonBit__Test__Driver9run__testGRP25SDJM519moonbit_2ddataframe41MoonBit__Test__Driver__Internal__No__ArgsE(async_tests, filename, index, handle_start, handle_result, error_to_string);
    let _tmp$2;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp$2 = _ok._0;
    ...
    if (_tmp$2) {
      ...
      let _tmp$3;
      const _bind$2 = _M0IP016_24default__implP25SDJM519moonbit_2ddataframe21MoonBit__Test__Driver9run__testGRP25SDJM519moonbit_2ddataframe43MoonBit__Test__Driver__Internal__With__ArgsE(async_tests, filename, index, handle_start, handle_result, error_to_string);
      let _tmp$4;
      if (_bind$2.$tag === 1) {
        const _ok = _bind$2;
        _tmp$4 = _ok._0;
      ...
      if (_tmp$4) {
        ...
        let _tmp$5;
        const _bind$3 = _M0IP016_24default__implP25SDJM519moonbit_2ddataframe21MoonBit__Test__Driver9run__testGRP25SDJM519moonbit_2ddataframe48MoonBit__Test__Driver__Internal__Async__No__ArgsE(async_tests, filename, index, handle_start, handle_result, error_to_string);
        let _tmp$6;
        if (_bind$3.$tag === 1) {
          const _ok = _bind$3;
          _tmp$6 = _ok._0;
        ...
        if (_tmp$6) {
          ...
          let _tmp$7;
          const _bind$4 = _M0IP016_24default__implP25SDJM519moonbit_2ddataframe21MoonBit__Test__Driver9run__testGRP25SDJM519moonbit_2ddataframe50MoonBit__Test__Driver__Internal__Async__With__ArgsE(async_tests, filename, index, handle_start, handle_result, error_to_string);
          let _tmp$8;
          if (_bind$4.$tag === 1) {
            const _ok = _bind$4;
            _tmp$8 = _ok._0;
          ...
          if (_tmp$8) {
            ...
            const _bind$5 = _M0IP016_24default__implP25SDJM519moonbit_2ddataframe21MoonBit__Test__Driver9run__testGRP25SDJM519moonbit_2ddataframe50MoonBit__Test__Driver__Internal__With__Bench__ArgsE(async_tests, filename, index, handle_start, handle_result, error_to_string);
            let _tmp$9;
            if (_bind$5.$tag === 1) {
              const _ok = _bind$5;
              _tmp$9 = _ok._0;
...
//# sourceMappingURL=moonbit-dataframe.internal_test.js.map
